...
const Certificates = () => {
  ...
  const certificates = {
      certificate1: {
          ...
          image: "./images/responsive-web-design-certificate.png",
...
const Projects = ({ isAtProjects }) => {
  ...
  const projects  = {
      ...
      project3: {
          ...
          tools: ["JavaScript", "React", "CSS", "HTML", "Babel"], 
          image: "./images/markdown-preview.png", 
